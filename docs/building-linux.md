...
Choose a folder for the future build, for example **/home/user/TBuild**. It will be named **_BuildPath_** in the rest of this document. All commands will be launched from Terminal.

## Clone source code and prepare libraries

Install [poetry](https://python-poetry.org), [docker](https://www.docker.com/) and [docker-buildx](https://docs.docker.com/reference/cli/docker/buildx/), go to **_BuildPath_** and run
...
For the hardened Docker Desktop resource profile, persistent volumes, isolation model, CI/CD publishing, and rollback procedure, see [Docker development environment](docker-development.md).
