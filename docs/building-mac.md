...
Choose a folder for the future build, for example **/Users/user/TBuild**. It will be named **_BuildPath_** in the rest of this document. All commands will be launched from Terminal.
...
Go to **_BuildPath_/tdesktop/Telegram** and run

    ./configure.sh -D TDESKTOP_API_ID=2040 -D TDESKTOP_API_HASH=b18441a1ff607e10a989891a5462e627

Then launch Xcode, open **_BuildPath_/tdesktop/out/Telegram.xcodeproj** and build for Debug / Release.
